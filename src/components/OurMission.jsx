    ...
    <div className="flex flex-col md:flex-row items-center mb-[3rem] md:items-start justify-between pt-6 md:p-12 bg-white">
        ...
        <div className="w-full md:w-1/2 px-28 pt-20">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            UpGrowth is committed to amplify our client's business to new
            heights by harnessing the power of innovative digital marketing
            strategies to accelerate growth and achieve real business outcomes.
          </p>
