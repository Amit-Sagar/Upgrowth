         ...
         <div className="w-full text-center py-20">
                <div className="bg-[url('https://www.singlegrain.com/wp-content/themes/singlegrain/assets/dist/images/redesign2023/home/testimonials/bg.png')] flex justify-center items-center gap-28 text-3xl pb-10">
                  <span onClick={PreUser} className=" cursor-pointer">
                    <img className='bg-gray-500 p-5 rounded-full rotate-180 hover:bg-gray-700 duration-200' src="https://www.singlegrain.com/wp-content/themes/singlegrain/assets/dist/images/redesign2023/arrows/cta-large.svg" alt="" />
                  </span>
                  <img className=" rounded-[50%]" src={user[userIndex].img} />
                  <span onClick={NextUser} className=" cursor-pointer">
                    <img className='bg-gray-500 p-5 rounded-full hover:bg-gray-700 duration-200' src="https://www.singlegrain.com/wp-content/themes/singlegrain/assets/dist/images/redesign2023/arrows/cta-large.svg" alt="" />
                  </span>
                </div>
