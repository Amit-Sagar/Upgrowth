...
const LearnMoreSection = () => {
  return (
    <div className="">
      <p className="text-6xl font-bold pl-10 py-20">Learn More About the <br />Work We’ve Done</p>
      <div className="flex justify-center items-center gap-5 flex-wrap px-[5%] pb-20">
      {leanMoreData.map((item, index) => {
        return index !== leanMoreData.length - 1 ? (
          <div
            key={index}
            className="w-[300px] h-[300px] relative bg-cover bg-center bg-no-repeat p-6 rounded-lg flex flex-col justify-center items-center gap-5 cursor-pointer hover:opacity-60 duration-300"
            style={{
