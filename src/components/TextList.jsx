...
const TextList = () => {
  ...
  return (
    <div className="flex justify-center items-center space-y-4 px-20 bg-[url('https://www.singlegrain.com/wp-content/themes/singlegrain/assets/dist/images/redesign2023/home/hero/bg.jpg')] w-[95%] py-10 rounded-xl">
      ...
      <p className='text-white text-6xl font-bold mb-10'>Our Growth Methodology</p>
        {textData.map((item, index) => (
          <div
            ...
            {activeIndex === index && (
              <span className="text-white"><FaRegHandPointRight /></span> 
            )}
            <span>{item.text}</span>
          </div>
        ))}
      ...
      <div className="text-white w-[40%] text-xl">
          ...
          <button className='flex justify-center items-center gap-3 font-bold px-10 py-3 mt-5 transition duration-200 border border-black bg-[rgb(42,42,42)] hover:bg-[rgb(67,67,67)]'>WORK WITH US <FaAnglesRight /> </button>
